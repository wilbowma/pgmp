...
(module+ main
  (mark 2000000 "exclusive-cond-test.rkt" 'run)
   (newline)
  (mark 2000000 "case-test.rkt" 'run)
   (newline)
  (mark 1000000  "class-test.rkt" 'run)
   (newline)
  (mark 10  "perflinty-list.rkt" 'run #f)
   (newline)
  (mark 10  "perflinty-vector.rkt" 'run #f)
   (newline)
  (mark 4000000  "perflinty-auto.rkt" 'run))
