...
General-purpose meta-programming systems should makes profile
information available to to enable meta-programmers to write their own,
...
Our approach is parametric over particular profilings technique and
meta-programming systems.
We demonstrate our approach by implementing it in two different
(albeit similar) meta-programming system: the syntactic extensions
