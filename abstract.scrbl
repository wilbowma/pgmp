...
Existing profile-guided meta-programs come with their own
special-purpose toolkits, specific to a single optimization, limiting
use and development of new profile-guided meta-programs.
