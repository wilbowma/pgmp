...
Profile directed optimization is a compiler technique that uses sample
data gathered at run-time to recompile and further optimize a program.
The profile data can be more accurate than static heuristics normally
used in a compiler and thus can lead to more optimized code.  Today's
compilers like .NET, LLVM, and GCC all provide some kind of profile
directed optimizations.

This work presents a system for using profile information to optimize
