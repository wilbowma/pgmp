...
optimizations on the LLVM bytecode.
...
optimizations. Further, we our mechanism reuses existing
meta-programming and profiling facilities, rather than implementing new
tools in front of the compiler.
...
compiling, and meta-programming tools.
